    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-user-role {
            ...
            color: #93c5fd; text-transform: uppercase; letter-spacing: 0.8px;
            margin-top: 2px;
        }
        ...
        .nav-badge {
            margin-left: auto; background: #3b82f6;
        ...
        .data-table th {
            ...
            padding: 0 0 12px; border-bottom: 2px solid #f1f5f9;
        }
        .data-table td {
            padding: 12px 0; font-size: 0.82rem; color: #334155;
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route(Auth::user()->role . '.peminjamans.index') }}" class="nav-item {{ request()->routeIs('admin.peminjaman*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route(Auth::user()->role . '.pengembalians.index') }}" class="nav-item {{ request()->routeIs('admin.pengembalian*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('admin.logs.index') }}" class="nav-item {{ request()->routeIs('admin.log*') ? 'active' : '' }}">
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<header class="topbar">
    <div class="topbar-left">
        ...
        <div>
            ...
            <div class="topbar-breadcrumb">{{ $pageBreadcrumb ?? 'Admin Panel' }}</div>
        </div>
    </div>
