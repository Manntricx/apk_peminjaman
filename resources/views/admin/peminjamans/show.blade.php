<x-admin-layout>
    ...
    <div style="max-width: 900px; margin: 0 auto;">
        <div style="margin-bottom: 20px;">
            <a href="{{ route('admin.peminjamans.index') }}" style="display: inline-flex; align-items: center; gap: 8px; color: #64748b; text-decoration: none; font-size: 0.85rem; font-weight: 500;">
                ...
                <div class="card-body">
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div style="font-weight: 600; color: #0f172a;">{{ $detail->alat->nama_alat }}</div>
                                    <div style="font-size: 0.72rem; color: #94a3b8;">{{ $detail->alat->kategori->nama_kategori }}</div>
                                </td>
                                <td style="text-align: center;">
                                    <span style="font-weight: 700; color: #3b82f6; background: #eff6ff; padding: 4px 10px; border-radius: 6px;">{{ $detail->jumlah }}</span>
                                </td>
                                <td>
