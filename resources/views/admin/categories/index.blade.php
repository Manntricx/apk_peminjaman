<x-admin-layout>
    ...
    <style>
        ...
        .btn-primary {
            ...
            font-weight: 600; font-size: 0.83rem; cursor: pointer; letter-spacing: 0.1px;
                ...
                <tbody>
                    @forelse($categories as $category)
                        <tr>
                            ...
                            <td style="max-width:400px;color:#94a3b8;font-size:0.825rem;">
                                {{ $category->deskripsi ?: '-' }}
                            </td>
                            <td>
                                <span style="background: rgba(59,130,246,0.1); padding: 4px 12px; border-radius: 99px; font-size: 0.75rem; font-weight: 700; color: #60a5fa; border: 1px solid rgba(59,130,246,0.2);">
                            ...
                            <td style="text-align:right;">
                                <div style="display:flex;justify-content:flex-end;gap:8px;">
                                    <button class="topbar-icon-btn"
                                        ...
                                        title="Edit" onclick="openEditCategoryModal(this)"
                                        data-id="{{ $category->id }}"
                    ...
                    @empty
                        <tr><td colspan="5" style="text-align:center;padding:40px;color:#94a3b8;">Belum ada data kategori.</td></tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="modal-panel">
            ...
            <div class="modal-header">
                ...
                <div class="modal-header-text">
                    ...
                    <div class="modal-subtitle">Masukkan nama dan deskripsi kategori alat</div>
                </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label">Nama Kategori <span class="form-req">*</span></label>
                        <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}" required
                            placeholder="Contoh: Elektronik, Olahraga, dsb." class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" rows="3" placeholder="Keterangan singkat mengenai kategori ini..."
        ...
        <div class="modal-panel">
            ...
            <div class="modal-header">
                ...
                <div class="modal-header-text">
                    ...
                    <div class="modal-subtitle">Perbarui informasi kategori alat</div>
                </div>
            ...
            <form id="editCategoryForm" action="" method="POST">
                ...
                <input type="hidden" name="_edit_id" id="editCategoryId" value="{{ old('_edit_id') }}">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label">Nama Kategori <span class="form-req">*</span></label>
                        <input type="text" name="nama_kategori" id="editNamaKategori"
                            value="{{ old('nama_kategori') }}" required class="form-control">
                        @error('nama_kategori') <div class="form-error">{{ $message }}</div> @enderror
                    </div>
                    <div class="form-group">
                        <label class="form-label">Deskripsi <span class="form-opt">(Opsional)</span></label>
    ...
    <div class="modal-overlay" id="deleteModal">
        <div class="modal-panel" style="max-width:440px;">
            ...
            <div class="modal-header" style="background:linear-gradient(135deg,rgba(220,38,38,0.15) 0%,rgba(15,23,42,0.1) 100%);">
                ...
                <div class="modal-header-text">
                    <div class="modal-title" style="color:#fca5a5;">Hapus Kategori</div>
                ...
                <div class="delete-warning-box">
                    ...
                    <div>
                        <div class="delete-warning-title">
                            Hapus kategori <span id="deleteItemName" style="color:#fca5a5;"></span>?
                        </div>
                        <div class="delete-warning-sub">Semua alat dalam kategori ini mungkin terpengaruh. Pastikan tidak ada alat terkait sebelum menghapus.</div>
                    </div>
                </div>
            </div>
    ...
    <script>
        var categoryBaseUrl = '{{ url('admin/categories') }}';
        ...
        function openEditCategoryModal(btn) {
            document.getElementById('editCategoryForm').action = btn.dataset.url;
            document.getElementById('editCategoryId').value   = btn.dataset.id;
            document.getElementById('editNamaKategori').value = btn.dataset.nama;
        ...
        @if($errors->any())
            (function() {
                var modal  = @json(old('_modal', 'createModal'));
                var editId = @json(old('_edit_id', ''));
                if (modal === 'editModal' && editId) {
                    document.getElementById('editCategoryForm').action = categoryBaseUrl + '/' + editId;
